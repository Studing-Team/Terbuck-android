    ...
    fun showBasicButtonToast(
        ...
        binding.run {
            ...
            buttonRegister.run {
                ...
                setOnClickListener {
                    when (fragment) {
                        is StudentCardRegisterFragment -> {
                            mixpanel.track("click_student_card_register_toast", null)
                        }
                        is MypageNotificationFragment -> {
                            mixpanel.track("click_push_alarm_toast", null)
                        }
                    }
