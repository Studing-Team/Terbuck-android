...
import com.terbuck.terbuck.databinding.RowImagePartnershipBinding
...
class PartnershipImageAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val binding =
            RowImagePartnershipBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class ViewHolder(val binding: RowImagePartnershipBinding) :
